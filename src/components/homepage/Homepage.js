...
<>
  <div className="visit">
    <a href="https://www.j-w-v.com/" target="_blank">
  ...
  <div id="particles-js">
            ...
            <ul>
              <li>
                <a
                  ...
                  href="https://codepen.io/j-w-v/pen/DIcJx"
                >
                  Pricing Tables
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://codepen.io/j-w-v/pen/RrMLjV"
                >
                  Portfolio Home Page
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://codepen.io/j-w-v/pen/PwqNvW"
                >
                  Login Process
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://codepen.io/j-w-v/pen/ORkmKo"
                >
              ...
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://codepen.io/j-w-v/pen/ZYLGMZ"
                >
                  Portfolio Opening Page
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://codepen.io/j-w-v/pen/JXdRqd"
                >
                  Blog Post Using Vertical Rhythm
                </a>
              </li>
              <li>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://codepen.io/j-w-v/pen/bEVvLM"
                >
                  Pricing Tables: Black And Yellow
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  18 Mobile First CSS Frameworks{" "}
                </a>
              </li>
              <li>
                <a
    ...
    <div className="container ">
      <div className="footer">
        <p>
          Made using the awesome{" "}
          <a href="https://github.com/VincentGarreau/particles.js/">
            Particles.js
          </a>
          , <a href="http://cpv2api.com/">Codepen V2 API</a> &amp;{" "}
